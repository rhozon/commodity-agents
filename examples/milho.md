# Milho — analise quantitativa

**Pergunta:** o que move o preco do milho?

Serie de 2018-01-01 a 2025-12-31, 2007 observacoes. Modelo: garch. Tentativas: 2.
...
1. **msgarch** — ARCH-LM rejeita homocedasticidade dos residuos (p=0.0405 < 0.05): ha heterocedasticidade nao capturada pelo modelo

> **Fonte trocada:** CEPEA indisponivel (coleta CEPEA nao implementada nesta versao); relatorio segue so com a serie internacional

![Serie de milho](milho.png)
...
Volatilidade estrutural de longo prazo: 0.0173.
Volatilidade condicional do ultimo instante: 0.0121.

## Testes de residuo

Ljung-Box (autocorrelacao remanescente): p-valor 0.6229.
ARCH-LM (heterocedasticidade nao capturada): p-valor 0.2337.

## Backtest

Horizonte de 20 passos. Modelo: MAPE 1.75%, RMSE 9.3326. Passeio aleatorio: MAPE 1.75%, RMSE 9.3326. Cobertura do intervalo de 95%: 1.00 (20 pontos, resolucao 0.05). Em resumo, o modelo previu zero por construcao (media zero na especificacao) e empatou com o passeio aleatorio no ponto.
